...
p<-ggplot(pct.comercio.pib,aes(year,pct)) +
  ...
  ggtitle("Comercio de Mercancias vs PIB Mundial",
          subtitle = subti)+
  coord_cartesian(xlim = c(1960,2015),ylim=c(0,1))+
  sin.titulos.ejes+
  theme_axon()
...
m.p <- rbind(pct.comercio(2015),pct.comercio(1960),
